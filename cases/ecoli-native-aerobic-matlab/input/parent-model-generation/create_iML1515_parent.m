% Turned function into script, creates aerobic model
...
%% Model configuration:
max_glucose_ur = 15; % 10 is the default iML value, 15 is the value used by Kamp2017
max_o2_ur = 20;

model_ana = changeRxnBounds(iML1515,'EX_o2_e',-max_o2_ur,'l');
