...
input_info.problem_path = fullfile(root_path,'cases','native-xylose-matlab');
input_info.parent_model_path = fullfile(root_path,'cases','native-xylose-matlab', 'input','sugar-parent.mat');
